...
exports.livenHeader = livenHeader;

function livenHeader() {
  var clock = document.querySelector('.header__clock');

  var time = function time() {
    return clock.textContent = new Date().toLocaleTimeString();
  };
...
(0, _header.livenHeader)();
var URL = 'https://jsonplaceholder.typicode.com/users';

function getUsersName() {
  return _getUsersName.apply(this, arguments);
}

function _getUsersName() {
  _getUsersName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response;
...
;
getUsersName().then(function (users) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var key = _step.value;
      var addTodoCardOptions = document.createElement('option');
      addTodoCardOptions.textContent = "".concat(key.name);
...
var addTodoCardSelect = document.querySelector(".addTodoCard-form__container-person");
var addTodoButton = document.querySelector('.todoBlock__button');
var addTodoCard = document.querySelector('.addTodoCard');
var todoBlockContainer = document.querySelector('.todoBlock__container');
var cardTitle = document.querySelector('.addTodoCard__input-title');
var cardDescription = document.querySelector(".addTodoCard-form__description"); // const cardSelection = document.querySelector('.addTodoCard-form__container-person');

var cardOptionSelected = document.querySelector('.opt');
var todoCardsCounter = document.querySelector('.todoBlock__header-counter');
todoCardsCounter.innerText = '0';
var inprogressContainer = document.querySelector('.inprogressBlock__container');
var inprogressCardsCounter = document.querySelector('.inprogressBlock__header-counter');
...
function createCard(_ref) {
  ...
  var cardContainerButtons = document.createElement('div');
  ...
  var cardContainerTransitionButton = document.createElement('div');
  ...
  var cardContainerTime = document.createElement('div');
  ...
  card.append(cardContainer1, cardContainer2); //--------------------------------move ---------------------------------

  cardButton3.addEventListener('click', function (event) {
    ...
    todoCards = todoCards.filter(function (item) {
      return !(item.id == "card-".concat(id));
    });
    card.remove();
    ...
    inprogressCardsCounter.innerText = inProgressCards.length; // --------------------------------back ---------------------------------
    ...
    cardButton1.addEventListener('click', function () {
      ...
      todoCards.push(card);
      inProgressCards = inProgressCards.filter(function (item) {
        return !(item.id == "card-".concat(id));
      });
      card.remove();
  ...
  cardButton1.addEventListener('click', function () {
    var editCard = document.querySelector('#add2');
    editCard.style.display = 'block';
    var todoBtnConfirm = document.querySelector('#confirm2');
    todoBtnConfirm.addEventListener('click', function () {
      return console.log('acasc');
    });
  });
  return card;
}

var todoBtnConfirm = document.querySelector('#confirm');
todoBtnConfirm.addEventListener('click', function () {
  var textTitle = cardTitle.value;
  var text = cardDescription.value;
  var user = addTodoCardSelect.value;
  var obj = {
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./header.js":"js/header.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
